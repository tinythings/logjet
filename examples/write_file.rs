...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    log_writer.push(RecordType::Metrics, 2, 1_700_000_000_000_000_100, b"fake-otlp-metrics")?;
    log_writer.push(RecordType::Traces, 3, 1_700_000_000_000_000_200, b"fake-otlp-traces")?;
